...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAIN] = LAYOUT(
        ...
        KC_LGUI, KC_Z, KC_X, KC_C,    KC_V,    KC_B,    KC_MUTE,            XXXXXXX,       KC_PSCR, XXXXXXX,            KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RGUI,
                             KC_LGUI, KC_LCTL, KC_LALT, LT(_LOWER, KC_ENT), KC_ESC,        KC_BSPC, LT(_RAISE, KC_SPC), KC_RALT, KC_RCTL, KC_RGUI
    ),
    /*
     * -------------------------------------------------------------------------------------------------------------------------------------
     ...
     * ------------------------| trans | trans | trans |_ADJUST| trans |---| DELETE| trans | trans | trans | trans |------------------------
     */
    [_LOWER] = LAYOUT(
