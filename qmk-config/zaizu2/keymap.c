...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* -----------------------------------------------------------------------------------------------------------------------------------------------
     * |   `   |   1   |   2   |   3   |   4   |   5   |--------------------------------------------|  6  |   7   |   8   |   9   |   0   |   ~   |
     * | TAB   |   Q   |   W   |   E   |   R   |   T   |--------------------------------------------|  Y  |   U   |   I   |   O   |   P   |CAPWORD|
    ...
    [_MAC] = LAYOUT(
        ...
        KC_LALT, KC_Z, KC_X, KC_C,    KC_V,    KC_B,   KC_MUTE,     DF(_WIN),             KC_PSCR,        XXXXXXX,     KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RALT,
    ...
    [_WIN] = LAYOUT(
        ...
        KC_TAB,  KC_Q, KC_W, KC_E,    KC_R,    KC_T,                                                                 KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,    CW_TOGG,
        KC_LSFT, KC_A, KC_S, KC_D,    KC_F,    KC_G,                                                                 KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, RSFT_T(KC_QUOT),
        KC_LGUI, KC_Z, KC_X, KC_C,    KC_V,    KC_B,   KC_MUTE,    DF(_MAC),             KC_PSCR,        XXXXXXX,    KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RGUI,
    ...
    [_ADJUST] = LAYOUT(
        ...
        RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, KC_BRID, _______, _______,        _______, _______, _______, _______, _______, _______, _______, _______,
